...
<script src="resources/js/polyfill/nodelist-foreach.js"></script>
<script src="resources/js/material-components-web.min.js"></script>
<script src="resources/js/material-keycloak-theme.js"></script>
<@layout.registrationLayout; section>
    <#if section = "header">
        ${msg("mobileHeader",realm.displayName)}
		<p id="kc-header-p">
            ${msg("mobileTitle")}
		</p>
    <#elseif section = "form">
		<form id="kc-sms-code-login-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
			...
			<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon ${properties.kcLabelClass!}">
				...
				<div class="${properties.kcLabelWrapperClass!}">
					<label for="code" class="mdc-floating-label ${properties.kcLabelClass!}">${msg("MobileNumber")?no_esc}</label>
				</div>
